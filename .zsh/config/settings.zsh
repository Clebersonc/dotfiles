...
# Canging Directories
DIRSTACKSIZE=9 # The  maximum size of the director stack for 'pushd' and 'popd'.
...
zstyle ':completion:*' list-colors ${(s.:.)LS_COLORS} # Match dircolors with completion scheme.
...
setopt MENU_COMPLETE # Instead of listing possibilities, select the fisrt match immediately.
...
# History
HISTFILE="$ZDOTDIR/cache/.zshhistory" # Where history logs are stored.
