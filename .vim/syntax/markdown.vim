...
syn match HeadingUnderline  "^[=-]\+$" contains=mdCode,mdBold,mdLink,mdLinkText
...
hi def link mdCode          Comment
hi def link mdBold          Comment
hi def link mdLink          Comment
hi def link mdLinkText      Comment
" hi def link mdHeader        Identifier
hi def link mdHeader        PreProc
hi def link mdHeader2       Type
" hi def link mdHeader3       PreProc
hi def link mdHeader3       Identifier
hi def link mdHeader4       Statement
hi def link mdHeader5       Constant
hi def link mdHeader6       Label
hi def link HeadingUnderline Delimiter
